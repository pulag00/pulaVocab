...
public interface IVocabularyApiClient
{
    ...
    Task<VocabularyEntryResponse?> GetByIdAsync(Guid id, CancellationToken cancellationToken = default); Task<VocabularyLookupResponse> AutocompleteAsync(VocabularyLookupRequest request, CancellationToken cancellationToken = default); Task<VocabularyEntryResponse> CreateAsync(CreateVocabularyEntryRequest request, CancellationToken cancellationToken = default);
